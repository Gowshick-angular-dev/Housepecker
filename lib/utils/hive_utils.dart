...
class HiveUtils {
  ...
  static void setCurrentAddress(String data) async {
    await Hive.box(HiveKeys.currentAddressBox).put(HiveKeys.currentAddress, data);
  }

  static dynamic getCurrentAddress() {
    return Hive.box(HiveKeys.currentAddressBox).get(HiveKeys.currentAddress);
  }
