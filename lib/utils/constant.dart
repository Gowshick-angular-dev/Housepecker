...
import 'package:Housepecker/data/model/system_settings_model.dart';
...
class Constant {
  ...
  static String googlePlaceAPIkey = "AIzaSyDDJ17OjVJ0TS2qYt7GMOnrMjAu1CYZFg8";

  ///admob
  static bool isAdmobAdsEnabled = false;
  //Banner
  static String admobBannerAndroid = "com.ownhouse.customer";
  static String admobBannerIos = "com.ownhouse.customer";
  //Interstitial
...
// public key
  ...
  static String Newsale = "2";
  static String Resale = "3";
  ...
  static Map<SystemSetting, String> systemSettingKeys = {
    ...
    SystemSetting.systemFirstBanner: "advertisement_first_banner",
    SystemSetting.systemSecondBanner: "advertisement_second_banner",
    SystemSetting.myAdvertisements: "my_advert",
    SystemSetting.myProperties: "my_property_count",
    SystemSetting.myProjects: "my_project_count",
    SystemSetting.totalViews: "advertisement_second_banner",
  };
