...
class UiUtils {
  ...
  static String trimNumberToOneDecimal(String numberString) {
    try {
  ...
  static Widget getImage(String url,
    ...
    return CachedNetworkImage(
      ...
      placeholder: (context, url) {
        return Image.asset("assets/profile/noimg.png", fit: fit,
          width: width,
          height: height,);
      },
                        ...
                        Material(
                          ...
                          child: InkWell(
                            ...
                            child: Padding(
                              ...
                              child: Image.asset("assets/propertylist/__back .png",width: 20,height: 20,fit: BoxFit.cover,),
                            ),
                          ),
                        ),
                      ],
