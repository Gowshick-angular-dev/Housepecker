...
class FetchSystemSettingsCubit extends Cubit<FetchSystemSettingsState>
  ...
  dynamic getSetting(SystemSetting selected) {
    ...
    if (state is FetchSystemSettingsSuccess) {
      ...
      if (selected == SystemSetting.myAdvertisements) {
        return settings['my_advert'];
      }

      if (selected == SystemSetting.myProperties) {
        return settings['my_property_count'];
      }

      if (selected == SystemSetting.myProjects) {
        return settings['my_project_count'];
      }

      if (selected == SystemSetting.totalViews) {
        return settings['my_project_count'];
      }
