...
import 'package:Housepecker/data/model/app_settings_datamodel.dart';
import 'package:Housepecker/exports/main_export.dart';
import 'package:Housepecker/utils/AppIcon.dart';
import 'package:Housepecker/utils/hive_keys.dart';
...
class LoadAppSettings {
  Future<void> load() async {
    try {
      Map response = await Api.get(url: Api.getAppSettings);
