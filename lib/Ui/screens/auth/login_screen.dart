...
import 'package:Housepecker/Ui/screens/auth/register.dart';
import 'package:Housepecker/settings.dart';
...
class LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (context.watch<FetchSystemSettingsCubit>().state
      ...
      Constant.isDemoModeOn = context
          ...
          .getSetting(SystemSetting.demoMode) ?? false;
    }
                      ...
                      if (state is VerifyOtpSuccess) {
                        if (widget.isDeleteAccount ?? false) {
                          ...
                          context.read<LoginCubit>().login(
                              phoneNumber: '91${mobileNumController.text}',
                              otp: otpIs,
                          );
                        }
                      }
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Image.asset("assets/Login/__Otp.png",width: double.infinity,),
              ),
            ],
          ),
        ),
              ...
              children: <Widget>[
                ...
                PinFieldAutoFill(
                  ...
                  decoration: BoxLooseDecoration(
                    ...
                    gapSpace:10,
                    strokeColorBuilder: PinListenColorBuilder(Color(0xfff5f5f5), Color(0xfff5f5f5)),
                    bgColorBuilder: const FixedColorBuilder(Color(0xfff5f5f5)),
                    strokeWidth: 1.0,
                  ),
                  currentCode: demoOTP(),
                  inputFormatters: [
                  ...
                  onCodeSubmitted: (code) {
                    if (widget.isDeleteAccount ?? false) {
                      context
                          .read<VerifyOtpCubit>()
                          .verifyOTP(verificationId: mobileNumController.text, otp: code);
                    } else {
                      context
                          .read<VerifyOtpCubit>()
                          .verifyOTP(verificationId: mobileNumController.text, otp: code);
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.only(left: 10,right: 10),
                  child: Image.asset("assets/Login/__Login.png",width: double.infinity,),
                ),
              ],
            ),
          ),
  ...
  Future<void> onTapLogin() async {
    ...
    if (widget.isDeleteAccount ?? false) {
      context
          .read<VerifyOtpCubit>()
          .verifyOTP(verificationId: mobileNumController.text, otp: otpIs);
    } else {
      context
          .read<VerifyOtpCubit>()
          .verifyOTP(verificationId: mobileNumController.text, otp: otpIs);
