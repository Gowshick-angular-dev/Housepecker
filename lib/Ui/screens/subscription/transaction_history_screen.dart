          ...
          children: [
            ...
            GestureDetector(
              onTap: () async {
                ...
                //   AppSettings.hostUrl + Api.generateInvoice,
                //   queryParameters: {
                //     'id': transaction.id,
                //   },
                //   '/storage/emulated/0/Housepecker',
                ...
                // );
                // await launchUrl(
                //     Uri.parse(AppSettings.hostUrl + Api.generateInvoice));
                final Directory? downloadsDirectory = await getExternalStorageDirectory();

                final taskId = await FlutterDownloader.enqueue(
                  url: AppSettings.baseUrl + Api.generateInvoice + '?id=${transaction.id}',
                  headers: {},
