...
class ServiceDetail extends StatefulWidget {
  final int? id;
  const ServiceDetail({super.key, this.id});
...
class _ServiceDetailState extends State<ServiceDetail> {
  ...
  Future<void> getServiceDetails() async {
    ...
    var response = await Api.get(url: Api.serviceDetails, queryParameters: {
        ...
        return Column(
          ...
          children: [
            ListTile(
              ...
              onTap: () async {
                String deepLink = "https://${AppSettings.shareNavigationWebUrl}/service/$slugId";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: loading ? Text('') : Text('${serviceDetails!['title']}',
          style: TextStyle(
                        ...
                        if(serviceDetails!['image'].length > 0)
                          Positioned(
                            ...
                            child: Row(
                              ...
                              children: [
                                CustomDotsIndicator(
                                  dotsCount: serviceDetails!['image'].length,
                      ...
                      child: Row(
                        ...
                        children: [
                          ClipRRect(
                              ...
                              child: Image.network("${serviceDetails!['photo']}",width: 70,height: 70,)),
                          SizedBox(width: 10,),
                          Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                    ...
                                    Expanded(
                                      child: Row(
                                        children: [
                                          ...
                                          SizedBox(width: 2,),
                                          if(serviceDetails!['status'] == 'Verified')
                                            Image.asset("assets/verified.png",width: 20,height: 20,),
                                        ],
                                      ),
                                    ),
                                    SizedBox(width: 10,),
                                    Text('RS. ${serviceDetails!['price'] ?? 0}/-',
                                      style: TextStyle(
                                        fontSize: 12,
                                        color: Colors.black,
                                        fontWeight: FontWeight.w600,
                                ...
                                Row(
                                  children: [
                                    ...
                                    SizedBox(width: 5,),
                                    Text('${UiUtils.trimNumberToOneDecimal(serviceDetails!['reviews_avg_ratting'] ?? '0')}'
                                        ' (${serviceDetails!['user_count']} Ratings)',style: TextStyle(
                                        fontSize: 11,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SingleChildScrollView(
                            ...
                            child: Row(
                              children: [
                                for(var ser in serviceDetails!['service_type'])
                                  Padding(
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 10,),
                          Text('${serviceDetails!['description']}',style: TextStyle(
                              fontSize: 12,
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                InkWell(
                  onTap: () async {
                    final url = 'tel:${serviceDetails!['phone']}'; // Create a tel URL with the phone number
                ...
                // InkWell(
                //   onTap: () async {
                //     final url = 'sms:${serviceDetails!['phone']}'; // Create a tel URL with the phone number
                //     if (await canLaunchUrl(Uri.parse(url))) {
                //       await launchUrl(Uri.parse(url));
                //     } else {
                //       throw 'Could not launch $url';
                ...
                InkWell(
                  onTap: () async {
                    final url = 'whatsapp://send?phone=:+91${serviceDetails!['whatsapp_number']}&text='; // Create a tel URL with the phone number
                    if (await canLaunchUrl(Uri.parse(url))) {
                      await launchUrl(Uri.parse(url));
                    } else {
                      throw 'Could not launch $url';
