                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (
                          ...
                          return ChatTile(
                            ...
                            isLastItem: index == state.chatedUserList.length - 1,
                          );
                        }),
                  ),
      ...
      child: AbsorbPointer(
        ...
        child: Container(
          ...
          child: Column(
            children: [
              Padding(
                padding: const EdgeInsets.only(left: 12.0,right: 12,bottom: 5,top: 15),
                child: Row(
                  children: [
                    Stack(
                      children: [
              ...
              if (!isLastItem)
                ...
                child: Divider(color: Color(0xffefefef),thickness: 2,),
              )
            ],
          ),
        ),
