...
import 'package:Housepecker/Ui/screens/proprties/AddProperyScreens/property_success.dart';
...
class _SetProeprtyParametersScreenState
  ...
  Widget buildDynamicField(Map parameter, int index) {
    ...
    if (field is AbstractDropdown) {
      print('jjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj: ${apiParameters}');
      if(widget.propertyDetails?['property_type'] == '1' || widget.propertyDetails?['property_type'] == 1) {
        if(parameter['name'] == 'Rent type') {
        ...
        } else if(parameter['name'] != 'Sale Type') {
          if (parameter['name'] == 'Residential' ||
              parameter['name'] == 'Commercial') {
            var selected = parameter['value'];
            if (selected == "") {
              selected = (parameter['type_values'] as List).first;
            }
        ...
        } else if(parameter['name'] != 'Rent type') {
          if (parameter['name'] == 'Residential' ||
              parameter['name'] == 'Commercial') {
            var selected = parameter['value'];
            if (selected == "") {
    ...
    ///Returning field
    print('oooooooooooooooooooooooooo: ${dynamicField}, ${widget.propertyDetails}');
    return dynamicField;
  }
