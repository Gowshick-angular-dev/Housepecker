...
class ReportProjectScreen extends StatefulWidget {
  final int propertyId;
  const ReportProjectScreen({Key? key, required this.propertyId})
      : super(key: key);

  @override
  State<ReportProjectScreen> createState() => _ReportProjectScreenState();
}

class _ReportProjectScreenState extends State<ReportProjectScreen> {
