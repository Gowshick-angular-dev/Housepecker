...
///ownhouse configuration file
/// Configure your app from here
/// Most of basic configuration will be from here
/// For theme colors go to [lib/Ui/Theme/theme.dart]
class AppSettings {
  ///Basic Settings
  static const String applicationName = 'Housepecker';
  static const String androidPackageName = 'com.ownhouse.customer';
  ...
  ///API Setting
  static const String hostUrl = "https://admin.housepecker.com/";
  // static const String hostUrl = "https://house.vrikshatech.in/";
...
it will call API in background without showing the process and when data available it will replace it with new data */
  ...
  ///Native deep link
  static const String shareNavigationWebUrl = "housepecker.com";
...
//!TODO: End deprecated
 ...
 Country number choose option in login screen. if your App is for only one country this might be helpful*/
  ...
  static List<HomeScreenSections> sections = [
    ...
    HomeScreenSections.banner,
    HomeScreenSections.Premiumpropertiesforsale,
